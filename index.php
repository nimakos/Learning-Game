...
<html>
	...
	<body class="body">
		<header class="mainheader">
			<img src="photos/logo.gif" width="350" height="120">
			<b><i><?php if(isset($_SESSION['login_user']))echo"Καλώς ήρθες : ", $login_session; ?></i></b>
		</header>
				...
				<article class="bottomcontent">
					...
					<content>
						<p> 
							...
							που είναι ιδιαίτερα χρήσιμο.Τέλος υπάρχει η δυνατότητα επικοινωνίας απευθείας από τη σελίδα για απορίες ή καί για προτάσεις.
						</p>				
					</content>
				</article>
